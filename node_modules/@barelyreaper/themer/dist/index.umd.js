(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Themer = factory(global.feather));
  ...
  function Themer({
    ...
    function getIcon(theme) {
      if (!feather__default['default']) {
        throw new Error('From Themer, Missing dependency `feather-icons`');
      }

      switch (theme) {
        case 'system': {
          return feather__default['default'].icons['circle'].toSvg({
            height: 18,
            width: 18,
          });
        }
        case 'light': {
          return feather__default['default'].icons['sun'].toSvg({
            fill: 'currentColor',
            height: 18,
            width: 18,
          });
        ...
        case 'dark': {
          return feather__default['default'].icons['moon'].toSvg({
            fill: 'currentColor',
            height: 18,
            width: 18,
          });
