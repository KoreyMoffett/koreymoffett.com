...
<body>
    ...
    <section class="section">
        <div class="container">
            <h1 class="title">Merry Christmas Everyone</h1>
            <h1 class="subtitle">Happy Holidays</h1>
            <br>
            <p class="has-text-black">It's Christmas today! Merry Christmas and Happy Holidays to everyone.
            </p>
