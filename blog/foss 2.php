...
<body>
    ...
    <section class="section">
        <div class="container">
            <h1 class="title">Why use FOSS?</h1>
            <h1 class="subtitle">Why should you care?</h1>
            <br>
            <p class="has-text-black">I guess first I should start of by explaining what FOSS is, FOSS is Free and Open Source Software.
                <br> For a program or software to be consitered free(as in freedom, has nothing to do with price.) it first has to meet the four essential freedoms.
                <br>
                <br>
                <ul>
                    <li>Freedom 0: The freedom to run the program as you wish, for any purpose.<li>
                        <li>Freedom 1: The freedom to study how the program works, and change it so it does your computing as you wish.</li>
                        <li>Freedom 2: The freedom to redistribute copies so you can help others.</li>
                        <li>Freedoom 3: The freedom to distribute copies of your modified verison to others. By doing this you can give the whole community a chance to benefit from your changes. Access to the source code is a necessity.</li>
                </ul>
                <br>
                <br>
                Now, to answer the question, "Why should you care about FOSS?"<br>
